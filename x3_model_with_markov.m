...
for i_d = 1:numel(dhist)
    ...
    %         
        ...
        test_model = model_the_behaviour_with_markov_walk(h, r, t, X0 , this_SD, 1, this_sub, COLLAPSE);
        
        
        % out = model_the_behaviour_with_markov_walk(h, r, [], X0 , 0, '');
        
        cost_mse = @(x) sum(abs(r(3:end)'/10 - model_the_behaviour_with_markov_walk(h, r, t, x , this_SD, 0, '', COLLAPSE))/20); % MSE cost function.
        cost_esq = @(x) sum((r(3:end)'/10 - model_the_behaviour_with_markov_walk(h, r, t, x , this_SD, 0, '', COLLAPSE)).^2/20); % MSE cost function.
        ...
        for i_cost = 1 %:2
            ...
            if do_gradient_descent
                ...
                [out1, fh1] = model_the_behaviour_with_markov_walk(h, r, t, X_optimal_1 , this_SD, 1, this_sub, COLLAPSE);
            end
            ...
            if do_particle_swarm
                ...
                [out2, fh2] = model_the_behaviour_with_markov_walk(h, r, t, x_optimal_2 , this_SD, 1, this_sub, COLLAPSE);
            end
            ...
            if do_globalsearch
                ...
                disp('Minimum sum of squares:');
                disp(fval);
                [out3, fh3] = model_the_behaviour_with_markov_walk(h, r, t, x_optimal_3 , this_SD, 1, this_sub, COLLAPSE);
            ...
            for j=3
                fn_to_use = sprintf('figures_Markov/model_cost_%s_%s_%s.jpg',prefixes{j}, cost_l, this_sub);
...
saved_model_parameters_Markov = saved_model_parameters;
% save saved_model_parameters_lowSD.mat saved_model_parameters_lowSD
save saved_model_parameters_Markov.mat saved_model_parameters_Markov;