...
load saved_model_parameters.mat;
p=saved_model_parameters;
...
m=[];
for i=1:numel(saved_model_parameters)
    m=[m; saved_model_parameters{i}{1}];
end
...
my_ylabels = {'\gamma','\alpha','\beta','\sigma'};
